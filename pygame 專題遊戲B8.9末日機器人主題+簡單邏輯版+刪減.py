...
guide_text_lines = [
    ...
    "",
    "[簡要開發日誌]",
    "從開學期初開始製作總共花了超過105小時以上製作，原本還有更多功能大餅有點畫的太大了，所以後來刪減了很多內容才完成。",
    "主要歷經A1、A2、A3、A4、A5、B1、B2、B3、B4、B5、B6、B7、B8、B8.5、B9(以擱置的3D功能版)、接續B8.5的B8.6、B8.7、B8.8、B8.9、C1、C2多個版本迭代，為了方便上傳最後我們直接整合成同一個檔。",
