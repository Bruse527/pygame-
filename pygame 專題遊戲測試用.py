...
class Boss:
    def __init__(self, boss_type, level=5):
        ...
        if self.b_type == "YELLOW": self.max_hp, self.color, self.speed = 1000 + level*150, YELLOW, 3.0
        elif self.b_type == "RED": self.max_hp, self.color, self.speed, self.aim_x, self.aim_y = 1500 + level*150, RED, 2.5, 0, 0
        elif self.b_type == "PURPLE": self.max_hp, self.color, self.speed = 800 + level*150, PURPLE, 2.0
...
while running:
    ...
    if game_state == "MENU":
        ...
        subtitle = font.render("驅魔人", True, WHITE)
